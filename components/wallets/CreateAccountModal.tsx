  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      <div>
        ...
        <input value={p.createAccountName} onChange={p.setCreateAccountName} placeholder="e.g. Payroll, Operations" style={{ width: "100%", marginTop: "8px", padding: "13px 14px", borderRadius: "12px", border: "1.5px solid var(--input-border)", background: "var(--surface2)", outline: "none", fontSize: "13.5px", color: "var(--ink)", boxSizing: "border-box" }} />
      </div>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", gap: "10px", marginTop: "2px" }}>
        <button onClick={p.closeModal} style={{ padding: "12px 22px", borderRadius: "12px", border: "none", background: "var(--surface2)", color: "var(--ink)", fontFamily: "'Space Grotesk',sans-serif", fontSize: "13px", fontWeight: "700", cursor: "pointer" }}>Cancel</button>
