...
export const DARK_HC_OVERRIDES = {"--surface2":"rgba(255,255,255,0.09)","--surface3":"rgba(255,255,255,0.16)","--border":"rgba(255,255,255,0.18)","--glass-border":"rgba(255,255,255,0.18)","--muted2":"#9E9BC0","--input-bg":"rgba(255,255,255,0.09)","--input-border":"rgba(255,255,255,0.28)","--modal-bg":"rgba(10,9,17,0.97)","--panel":"#17161d"};
