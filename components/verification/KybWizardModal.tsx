  ...
  if (p.submitted) {
    return (
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "10px", padding: "12px 0 6px", textAlign: "center" }}>
        ...
        <span style={{ fontFamily: "Geist,'Space Grotesk',sans-serif", fontSize: "14.5px", fontWeight: "700" }}>KYB submitted</span>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
      ...
      <div style={{ display: "flex", gap: "8px" }}>
        {p.step > 1 ? (
          <button type="button" onClick={p.backStep} disabled={p.busy} style={{ flex: 1, padding: "13px", borderRadius: "14px", border: "1.5px solid var(--border)", background: "var(--surface2)", color: "var(--ink)", fontFamily: "Geist,'Space Grotesk',sans-serif", fontSize: "13.5px", fontWeight: "700", cursor: "pointer" }}>
            Back
          </button>
        ) : null}
        <button
          ...
          style={{ flex: 2, padding: "13px", borderRadius: "14px", border: "none", background: "var(--indigo)", color: "var(--indigo-on)", fontFamily: "Geist,'Space Grotesk',sans-serif", fontSize: "13.5px", fontWeight: "700", cursor: p.busy ? "wait" : "pointer", opacity: p.busy ? 0.7 : 1 }}
        >
